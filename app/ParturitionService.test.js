...
describe('ParturitionService', () => {
    ...
    describe('performParturition', () => {
        it('performs the parturition process successfully', async () => {
            ...
            // Mock fs operations
            fs.readFile.mockResolvedValue('Parturition content ---START_USER--- User Info ---END_USER---');
...
---END_IDENTITY---
            ...
            expect(fs.writeFile).toHaveBeenCalledWith(expect.stringContaining('Identity.md'), expect.stringContaining('Identity Content'));
        ...
        it('handles LLM failure gracefully', async () => {
            ...
            expect(fs.writeFile).not.toHaveBeenCalledWith(expect.stringContaining('Soul.md'), expect.any(String));
        });
    });
