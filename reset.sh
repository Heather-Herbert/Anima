...
echo "Resetting Anima environment..."

# Remove generated personality files
rm -f "$DIR/Personality/Soul.md"
rm -f "$DIR/Personality/Identity.md"
rm -f "$DIR/Personality/user.md"
...
echo "Reset complete. Ready for new birth cycle."
